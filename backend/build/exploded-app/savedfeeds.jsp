...
<%@ page import="com.dikulous.ric.myapplication.backend.model.RssEntity"%>
<%@ page import="java.util.List" %>

<%
    List<RssEntity> rssEntites = RssDatastore.readRssEntities();
%>
...
<html>
    ...
    <body style="padding-top: 70px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <table id="rssTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>URL</th>
                                <th>Country Code</th>
                        ...
                        <tbody>
                        <% for(RssEntity rssEntity:rssEntites){ %>
                            <tr>
                                <td><%=rssEntity.getUrl()%></td>
                                <td><%=rssEntity.getCountryCode()%></td>
                                <td><%=rssEntity.getCategory()%></td>
                            </tr>
                        <% } %>
                        </tbody>
                    </table>
        ...
        <script src="/js/savedFeeds.js"></script>
    </body>
</html>